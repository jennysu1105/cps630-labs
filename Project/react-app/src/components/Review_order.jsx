...
const Review_order = () => {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8000/getCartItems.php", {params: {items: JSON.stringify(cookies.items)}}).then((response) => {
            ...
            axios.get("http://localhost:8000/submitOrder.php", {params: {total: price, user: cookies.user, payment: info['card_num'], postal: info['postal_code'], items: cookies.items}}).then((response) => {
                console.log(response.data);
